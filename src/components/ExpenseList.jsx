...
const ExpenseList = (props) => {
    ...
    const toggleStationary=()=>{
        setshowStationary(!showStationary);
    }
    const toggleFood=()=>{
    ...
    return (
        <div className='expense-list-cont'>
            ...
            <div className='checkboxes'>
                <input onChange={toggleStationary} checked={showStationary} type="checkbox" />
                <label>Stationary</label>
                <input onChange={toggleFood} checked={showFood} type="checkbox" />
                <label>Food</label>
                <input onChange={toggleRent} checked={showRent} type="checkbox" />
                <label>Rent</label>
            </div>
            <div className="expense-lists">
                {expData.length != 0 && expData.map((data) => {
                    let flag=false;
                    if(showStationary && data.expcat=="Stationary"){
                        flag=true;
                    }else if(showFood && data.expcat=="Food"){
                        flag=true;

                    }else if(showRent && data.expcat=="Rent"){
                        flag=true;
                    }
